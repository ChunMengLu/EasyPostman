...
public class HistoryPanel extends SingletonBasePanel {
    ...
    public void addRequestHistory(PreparedRequest req, HttpResponse resp) {
        ...
        // 添加到持久化管理器
        BeanFactory.getComponent().historyPersistenceService().addHistory(req, resp, requestTime);
    ...
    private void clearRequestHistory() {
        // 清空持久化的历史记录
        BeanFactory.getComponent().historyPersistenceService().clearHistory();
    ...
    private void loadPersistedHistory() {
        ...
        SwingWorker<List<Object>, Void> worker = new SwingWorker<>() {
            ...
            protected List<Object> doInBackground() {
                List<RequestHistoryItem> persistedHistory = BeanFactory.getComponent().historyPersistenceService().getHistory();
